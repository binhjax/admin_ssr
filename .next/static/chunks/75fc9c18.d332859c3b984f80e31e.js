        ...
        e.exports = (function() {
          ...
          function me(e, t, n) {
            e.isValid() &&
              ...
              ('FullYear' === t && le(e.year()) && 1 === e.month() && 29 === e.date()
                ? ((n = de(n)),
                  e._d['set' + (e._isUTC ? 'UTC' : '') + t](n, e.month(), et(n, e.month())))
          ...
          function at(e, t) {
            return e
              ? a(this._months)
                ...
                : this._months[(this._months.isFormat || st).test(t) ? 'format' : 'standalone'][
                    e.month()
                  ]
              : a(this._months)
              ? this._months
          ...
          function fn(e) {
            for (var t, n, s, i, r = 0; r < e.length; ) {
              for (
                t = (i = cn(e[r]).split('-')).length, n = (n = cn(e[r + 1])) ? n.split('-') : null;
                t > 0;
          ...
          function jn(e) {
            if (!e._d) {
              ...
              (e._a = f([t.year, t.month, n, t.hour, t.minute, t.second, t.millisecond], function(
                e
              ) {
          ...
          function cs(e, t) {
            ...
            return null === i
              ...
              : 0 ===
                (s =
                  60 * (n = ((i[i.length - 1] || []) + '').match(ds) || ['-', 0, 0])[1] + de(n[2]))
              ? 0
              : '+' === n[0]
              ? s
              : -s;
          ...
          function ws(e) {
            return (
              this._isUTC &&
                (this.utcOffset(0, e), (this._isUTC = !1), e && this.subtract(ms(this), 'm')),
              this
            );
          }
          function ps() {
          ...
          function ei() {
            ...
            return (
              this.isLocal() ||
                ((i = 0 === this.utcOffset() ? 'moment.utc' : 'moment.parseZone'), (r = 'Z')),
              (e = '[' + i + '("]'),
          ...
          function gi(e) {
            ...
            switch (((n = this._isUTC ? _i : mi), e)) {
              ...
              case 'hour':
                (t = this._d.valueOf()),
                  (t += di - fi(t + (this._isUTC ? 0 : this.utcOffset() * hi), di) - 1);
                break;
              case 'minute':
          ...
          function Ui(e) {
            return (
              u(this, '_erasNameRegex') || Ai.call(this), e ? this._erasNameRegex : this._erasRegex
            );
          }
          function Hi(e) {
            return (
              u(this, '_erasAbbrRegex') || Ai.call(this), e ? this._erasAbbrRegex : this._erasRegex
            );
          }
          function Fi(e) {
            return (
          ...
          function Bi(e, t, n, s, i) {
            ...
            return null == e
              ? Dt(this, s, i).year
              : (t > (r = St(e, s, i)) && (t = r), Qi.call(this, e, t, n, s, i));
          }
          ...
          function ia(e, t) {
            return (
              void 0 !== ea[e] &&
              (void 0 === t ? ea[e] : ((ea[e] = t), 's' === e && (ea.ss = t - 1), !0))
            );
          }
          function ra(e, t) {
