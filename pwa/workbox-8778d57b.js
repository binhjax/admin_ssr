define('./workbox-8778d57b.js', ['exports'], function(t) {
    ...
    handleRequest({ request: t, event: e }) {
      ...
      return (
        c instanceof Promise &&
          this.o &&
          (c = c.catch(n => this.o.handle({ url: s, request: t, event: e }))),
        c
      );
    }
  ...
  class y {
    ...
    async getAllMatching(
      ...
      return await this.transaction([t], 'readonly', (a, o) => {
        ...
        l.onsuccess = () => {
          const t = l.result;
          t ? (u.push(r ? t : t.value), i && u.length >= i ? o(u) : t.continue()) : o(u);
        };
      });
    }
  ...
  class q {
    ...
    async isURLExpired(t) {
      if (this.N) {
        return (await this.T.getTimestamp(t)) < Date.now() - 1e3 * this.N;
      }
      return !1;
    }
    async delete() {
  ...
  const M = { cacheWillUpdate: async ({ response: t }) => (t.redirected ? await O(t) : t) };
  class W extends E {
    constructor(t = {}) {
    ...
    async I(t, e) {
      ...
      return s || (e.event && 'install' === e.event.type ? await this.F(t, e) : await this.H(t, e));
    }
    async H(t, e) {
      let n;
      if (!this.B) throw new s('missing-precache-entry', { cacheName: this.cacheName, url: t.url });
  ...
  (t.CacheFirst = class extends E {
    ...
    (t.NetworkFirst = class extends E {
      ...
      async I(t, e) {
        ...
        if ((o || (o = await a), !o)) throw new s('no-response', { url: t.url });
        return o;
      }
